 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = (grad + min / 60 + sec / 3600) * 3.14 / 180
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial + initial * percent + (initial + initial * percent) * percent + (initial + initial * percent + (initial + (initial * percent) * percent) * percent
